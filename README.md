...
### Вывод
- Функция main принимает переменное количество аргументов с помощью *kwargs. 
...
- Программа вызывает функцию calculate_triangle_area(a, b, c) для вычисления площади и выводит результат с форматом до двух знаков после запятой.
  ...
  ## Вывод
Использование функций и модулей в Python позволяет создавать более чистый, эффективный и легко поддерживаемый код, что критично для создания крупных и сложных проектов. Они также способствуют улучшению читаемости кода, упрощая его понимание для других разработчиков, и обеспечивают лучшую масштабируемость проектов.
